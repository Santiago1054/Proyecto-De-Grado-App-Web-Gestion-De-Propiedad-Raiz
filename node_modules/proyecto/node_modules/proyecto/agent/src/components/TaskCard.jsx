                    ...
                    <aside name="side bar"
                        ...
                        <div className="h-full px-3 py-4  overflow-y-auto bg-blue-600 ">
                            <ul className="space-y-2 font-medium">
                                ...
                                {/*Al hacer click en este elemento, lleva al usuario al formulario */}
                            ...
                            <div name="Contenedor de filtros"
                                ...
                                <div className="flex flex-col items-center pb-10 ">
                                    ...
                                    <form name="form de los filtros"
                                        className="w-44 mx-96 ">
        ...
        return (
            <>
                ...
                <div name="Base de la tarjeta/propiedad"
                    className="w-auto h-60 max-w-3xl bg-white rounded-lg hover:outline hover:outline-sky-400 hover:outline-2 hover:shadow-md hover:shadow-blue-400 hover:bg-white duration-200 flex flex-row">

                    {/*Este elemento muestra la imagen que le asigno el usuario*/}
                    <img name="imagen"
                        className="rounded-tl-lg rounded-bl-lg w-1/3 h-auto aspect-square object-cover" src={task.imagen} alt="" />
                    ...
                    <div name="contenido de la  tarjeta"
                        className="py-8 w-2/3">

                        <h2 className="font-extrabold mb-2 text-2xl tracking-tight text-form text-justify px-10 ">{task.municipio + ', ' + task.departamento}</h2>

                        <h2 className="font-sans mb-2 text-1xl font-bold tracking-tight text-form text-justify px-10">{task.barrio + ', ' + task.direccionHogar}</h2>

                        {/*inicio de la Separacion*/}
                        <hr className="h-px my-4 bg-form border-0 px-10" />
                        {/*fin de la Separacion*/}
                        <h2 className=" font-sans mb-3 font-semibold text-sm text-form  text-justify px-10 ">Última modificación: {new Date(task.updatedAt).toLocaleString()} </h2>
                        <div name="botones para operar cada tarjeta"
                            className="flex justify-between items-center px-10 ">
                            <button name="ver detalles"
                                className="inline-flex items-start px-2 py-2 text-sm font-medium text-center text-white bg-form  hover:scale-105 duration-200"
                        ...
                        <div name="modal eliminar"
                            ...
                            <div className="bg-white rounded-lg shadow-md p-6 w-full max-w-md">
                                ...
                                <div className="flex items-center p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 " role="alert">
                                    ...
                                    <div>
                                        <span className="font-medium">¡IMPORTANTE!!</span> Esta acción no se puede deshacer.
                                    </div>
                                </div>
                    ...
                    {isDetailModalOpen && (
                        <div name="mostrar mas"
                            className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
                            <div className="bg-form rounded-lg shadow-md p-4 w-full max-w-5xl h-auto overflow-y-hidden">
                                <div className="max-h-[70vh] custom-scrollbar bg-pink-200">
                                    ...
                                    <div className="bg-form h-80">
                                        ...
                                        <br />
                                        <br />
                                        <h1 className="mb-4 text-3xl font-extrabold text-white md:text-5xl lg:text-7xl text-center"><span className="text-transparent bg-clip-text bg-gradient-to-r to-yellow-600 from-yellow-500">¡Hola, {user.username}!  </span> </h1><h1 className="mb-4 text-5xl font-extrabold text-white md:text-5xl lg:text-5xl text-center">¡Descubre todo lo que esta propiedad tiene para ofrecerte!</h1>
                                    </div>
                                    ...
                                    <div className="bg-modal h-auto">
                                        ...
                                        <h5 className="font-extrabold  mb-2 text-7xl tracking-tight text-white text-justify px-10">
                                            {task.municipio + ', ' + task.departamento}
                                        </h5>
                                        ...
                                        <br />
                                        <h2 className=" font-sans mb-3 font-bold text-2xl text-white text-justify px-10">Creado el {new Date(task.createdAt).toLocaleString()} </h2>
                                        <h2 className=" font-sans mb-3 font-semibold text-sm text-form  text-justify px-10"></h2>
                    ...
                    <div name="contenido de la  tarjeta"
                        ...
                        <div name="botones para operar cada tarjeta"
                            ...
                            <button name="Modal para Eliminar"
                                className="relative inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-pink-500 to-orange-400 group-hover:from-pink-500 group-hover:to-orange-400 hover:text-white  focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800"
                                onClick={handleDeleteClick}>
                                <span name="delete" className="relative px-5 py-2.5 transition-all ease-in duration-75 bg-white rounded-md group-hover:bg-opacity-0">
                                    Eliminar
                                </span>
                            </button>
                        </div>
