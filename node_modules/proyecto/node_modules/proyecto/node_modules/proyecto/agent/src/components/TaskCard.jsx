            ...
            {isAuthenticated ? (
                ...
                <>
                    <aside id="cta-button-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
                        <div className="h-full px-3 py-4  overflow-y-auto bg-form border border-backgroundColor ">
...
function TaskCard({ task }) {
    ...
    if (results == "") {
        ...
        return (
            ...
            <>
                <div className="w-auto h-auto max-w-8xl  bg-gray-800 border border-backgroundColor rounded-lg shadow  cursor-pointer opacity-50   hover:opacity-100 delay-60  hover:-m-2 delay-60 hover:bg-backgroundColor hover:text-form ">
                    <a href="#">
                        <img className="rounded-t-lg w-auto h-auto" src={task.imagen} alt="" />
                    </a>
                    <div className="p-2">
                        <a href="#">
                            <h5 className=" font-custom font-extrabold mb-2 text-7xl  tracking-tight text-form  ">{task.municipio + ', ' + task.departamento}</h5>
                        </a>
                        <a href="#">
                            <h5 className=" font-sans mb-2 text-3xl font-bold tracking-tight text-form ">{task.barrio + ', ' + task.direccionHogar}</h5>
                        </a>
                        <a href="#">
                            <h5 className=" mb-2 text-3xl font-bold tracking-tight text-form ">{'____________________________________________________ '}</h5>
                        </a>
                        <br></br>
                        <br></br>
                        <br></br>
                        <p className="font-custom mb-3 font-bold text-2xl text-form  text-justify px-10">{task.historial}</p>
                        <br></br>
                        <div>
                            ...
                            <a href="#">
                                <h5 className=" font-custom mb-2 text-2xl tracking-tight text-form ">{'Fecha de creacion: ' + new Date(task.createdAt).toLocaleString()}</h5>
                            </a>
                            <br></br>
                            <a href="#">
                                <h5 className=" font-custom mb-2 text-2xl  tracking-tight text-form ">{'Última modificación: ' + new Date(task.updatedAt).toLocaleString()}</h5>
                            </a>
